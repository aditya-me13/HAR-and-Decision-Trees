...
class Node:
    def __init__(self, to_split=None, split_val=0, depth=float('inf'), decision = None):
        ...
        def make_tree(X: pd.DataFrame, y:pd.Series, features:list, criterion:str, max_depth:int, node_):
            ...
            # for real outputs
                ...
                # for real inputs
                    ...
                    make_tree(left_df_X, left_df_y, features_, criterion, max_depth, new_node)
                    ...
                    make_tree(right_df_X, right_df_y, _features_, criterion, max_depth, new_node_)

                return                        

            
        self.Root = Node(depth = 0)   
        make_tree(X, y, list(X.columns), self.criterion, self.max_depth, self.Root)
        return None    
...
#         print("Recall: ", recall(y_hat, y[21:], cls))
